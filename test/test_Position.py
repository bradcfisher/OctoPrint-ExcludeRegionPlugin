...
class PositionTests(TestCase):
    ...
    def test_default_constructor(self):
        ...
        self.assertEqual(unit.X_AXIS, AxisPosition(), "X_AXIS should be a default AxisPosition instance")
        self.assertEqual(unit.Y_AXIS, AxisPosition(), "Y_AXIS should be a default AxisPosition instance")
        self.assertEqual(unit.Z_AXIS, AxisPosition(), "Z_AXIS should be a default AxisPosition instance")
        self.assertEqual(unit.E_AXIS, AxisPosition(0), "E_AXIS should be a default AxisPosition instance with a known position of 0")
    ...
    def test_copy_constructor(self):
        ...
        self.assertIsNot(unit.X_AXIS, toCopy.X_AXIS, "The X_AXIS property should be a different instance")
        self.assertIsNot(unit.Y_AXIS, toCopy.Y_AXIS, "The Y_AXIS property should be a different instance")
        self.assertIsNot(unit.Z_AXIS, toCopy.Z_AXIS, "The Z_AXIS property should be a different instance")
        self.assertIsNot(unit.E_AXIS, toCopy.E_AXIS, "The E_AXIS property should be a different instance")
        self.assertProperties(unit, PositionTests.expectedProperties)
    ...
    def test_setUnitMultiplier(self):
        ...
        self.assertEqual(unit.X_AXIS.unitMultiplier, 1234, "The X_AXIS unitMultiplier should be 1234")
        self.assertEqual(unit.Y_AXIS.unitMultiplier, 1234, "The Y_AXIS unitMultiplier should be 1234")
        self.assertEqual(unit.Z_AXIS.unitMultiplier, 1234, "The Z_AXIS unitMultiplier should be 1234")
        self.assertEqual(unit.E_AXIS.unitMultiplier, 1234, "The E_AXIS unitMultiplier should be 1234")
    ...
    def test_setPositionAbsoluteMode(self):
        ...
        self.assertEqual(unit.E_AXIS.absoluteMode, extruderAbsoluteMode,
